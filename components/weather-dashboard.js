    ...
    updateUI(data) {
        ...
        if (atmCard) {
            ...
            if (pressure !== undefined && pressure !== null) {
                ...
                atmCard.querySelector('.pressure-value').textContent = `${pressureNum.toFixed(2)} inHg`;
            ...
            this.createAtmosphericAnimation(atmCard, trend.class, parseFloat(uv), parseFloat(solar));
        }
